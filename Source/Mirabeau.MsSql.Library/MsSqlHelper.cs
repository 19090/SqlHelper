...
namespace Mirabeau.MsSql.Library
{
    ...
    public class MsSqlHelper : DatabaseHelperBase, IMsSqlHelper
    {
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A DbDataReader containing the resultset generated by the command</returns>
        public IEnumerable<TModel> ExecuteReaderToModel<TModel>(string connectionString, string storedProcedureName, params object[] parameterValues)
        {
            using (var reader = ExecuteReader(connectionString, storedProcedureName, parameterValues))
            {
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A DbDataReader containing the resultset generated by the command</returns>
        public async Task<IEnumerable<TModel>> ExecuteReaderToModelAsync<TModel>(string connectionString, string storedProcedureName, params object[] parameterValues)
        {
            using (var reader = await ExecuteReaderAsync(connectionString, storedProcedureName, parameterValues))
            {
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A DbDataReader containing the resultset generated by the command</returns>
        public async Task<IEnumerable<TModel>> ExecuteReaderToModelAsync<TModel>(DbConnection connection, string storedProcedureName, params object[] parameterValues)
        {
            using (var reader = await ExecuteReaderAsync(connection, storedProcedureName, parameterValues))
            {
                return await ModelMapper.MapAsync<TModel>(reader);
            }
        }
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A DbDataReader containing the resultset generated by the command</returns>
        public IEnumerable<TModel> ExecuteReaderToModel<TModel>(DbConnection connection, string storedProcedureName, params object[] parameterValues)
        {
            using (var reader = ExecuteReader(connection, storedProcedureName, parameterValues))
            {
                return ModelMapper.MapAsync<TModel>(reader).TaskResult();
            }
        }
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A DbDataReader containing the resultset generated by the command</returns>
        public async Task<IEnumerable<TModel>> ExecuteReaderToModelAsync<TModel>(DbTransaction transaction, string storedProcedureName, params object[] parameterValues)
        {
            using (var reader = await ExecuteReaderAsync(transaction, storedProcedureName, parameterValues))
            {
                return await ModelMapper.MapAsync<TModel>(reader);
            }
        }
        ...
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        /// <returns>A DbDataReader containing the resultset generated by the command</returns>
        public IEnumerable<TModel> ExecuteReaderToModel<TModel>(DbTransaction transaction, string storedProcedureName, params object[] parameterValues)
        {
            using (var reader = ExecuteReader(transaction, storedProcedureName, parameterValues))
            {
                return ModelMapper.MapAsync<TModel>(reader).TaskResult();
            }
        }
